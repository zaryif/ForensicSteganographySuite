...
if __name__ == "__main__":
    import sys
    print("Radiohead Vault (Python Edition)")
    if len(sys.argv) < 5:
        print("Usage: python3 vault.py <cover_image> <secret_file> <output_image> <password>")
        print("Example: python3 vault.py cover.png secret.txt vault.png MyStrongPass")
    else:
        try:
            hide(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
